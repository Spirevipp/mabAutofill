...
var autofill3C = function (d) {
	...
	scSerial[0].addEventListener("focus", tabFocus(dataInput["serial"]), true);

	//kjøpsdato

	var scDato = document.querySelectorAll("input[data-bind=\"date: purchaseDate, format: 'YYYY/MM/DD'\"]");
	scDato[0].addEventListener("focus", tabFocus(dataInput), true);
	...
	*/
	...
	scButikkref[0].addEventListener("focus", tabFocus(dataInput), true);

	//fornavn
	var scFornavn = document.querySelectorAll("input[data-bind=\"value: firstName\"]");
	scFornavn[0].addEventListener("focus", tabFocus(dataInput), true);

	//etternavn
	var scEtternavn = document.querySelectorAll("input[data-bind=\"value: lastName\"]");
	scEtternavn[0].addEventListener("focus", tabFocus(dataInput), true);
